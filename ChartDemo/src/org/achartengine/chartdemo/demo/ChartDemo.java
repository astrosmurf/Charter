...
import org.achartengine.chartdemo.demo.chart.XYChartBuilder2;
...
public class ChartDemo extends ListActivity {
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    mMenuText[0] = "Timestamp chart";
    mMenuSummary[0] = "Joakims first timestamp chart";
    mMenuText[1] = "Timestamp chart 2";
    mMenuSummary[1] = "A charting test where data is stored in a file";
  ...
  protected void onListItemClick(ListView l, View v, int position, long id) {
    ...
    if (position == 0) {
      ...
      intent = new Intent(this, XYChartBuilder2.class);
